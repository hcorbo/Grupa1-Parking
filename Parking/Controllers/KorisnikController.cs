...
namespace Parking.Controllers
{
    public class KorisnikController : Controller
    {
        ...
        public KorisnikController(ParkingContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("Ime,Prezime,Email,DatumRodjenja,Password,JeAktivan,DatumKreiranja,Uloga")] Korisnik korisnik)
        {
            if (id != korisnik.Id)
            {
                return NotFound();
